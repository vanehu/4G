...
package com.ailk.ecsp.lifecycle;
...
public interface Lifecycle {
     ...
     * 服务调用前事件
     * */
    public static final String BEFORE_SERVICE_INVOKE = "before_service_invoke";

    
    /**
     * 服务调用后事件
     * */
    public static final String AFTER_SERVICE_INVOKE = "after_service_invoke";    
