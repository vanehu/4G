...
CONST = (function(){
   ...
   //业务动作类型详细信息
	...
	var _CERT_READER_HANDLE_CUST 			= "经办人";
	var _CERT_READER_CREATE_CUST 			= "新建客户";
	var _CERT_READER_AUTH_CUSTOMER 			= "客户鉴权";
	var _CERT_READER_SECOND_BUSI_AUTH 		= "二次业务鉴权";
	var _CERT_READER_CUST_COLLECTION_USER	= "实名信息采集单使用人";
	
	//套餐成员CD 
	var _MAINPROD_ROLECD = {
		MAIN_ROLECD : "10100002", //主卡
		VICE_ROLECD : "20100002"  //副卡
	};
	
	return {
		CERT_READER_USER 				:_CERT_READER_USER,
		CERT_READER_AUTH_CUST 			:_CERT_READER_AUTH_CUST,
		CERT_READER_QUERY_CUST 			:_CERT_READER_QUERY_CUST,
		CERT_READER_HANDLE_CUST 		:_CERT_READER_HANDLE_CUST,
		CERT_READER_CREATE_CUST 		:_CERT_READER_CREATE_CUST,
		CERT_READER_AUTH_CUSTOMER 		:_CERT_READER_AUTH_CUSTOMER,
		CERT_READER_SECOND_BUSI_AUTH 	:_CERT_READER_SECOND_BUSI_AUTH,
		CERT_READER_CUST_COLLECTION_USER:_CERT_READER_CUST_COLLECTION_USER,
		RXSHGN:_RXSHGN,
		...
		MAINPROD_ROLECD : _MAINPROD_ROLECD
	};
})();
