 ...
 * @copyRight 亚信联创EC研发部
 */
@Controller("com.al.lte.portal.agent.controller.crm.OfferController")
...
public class OfferController extends BaseController {
	...
	public String queryChangeAttachOffer(@RequestParam("strParam") String param,Model model,HttpServletResponse response){
		...
		try{
	 	...
	 	return "/agent/offer/attach-offer";
	}
	...
	public String queryAttachSpec(@RequestParam("strParam") String param,Model model,HttpServletResponse response){
		...
		try{
	 	...
	 	return "/agent/offer/attach-spec";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/queryAttachSpecPhone", method = RequestMethod.GET)
	public String queryAttachSpecPhone(@RequestParam("strParam") String param,Model model,HttpServletResponse response){
		Map<String, Object> paramMap = new HashMap();
		try{
			SessionStaff sessionStaff = (SessionStaff) ServletUtils.getSessionAttribute(super.getRequest(),SysConstant.SESSION_KEY_LOGIN_STAFF);	
	 	...
	 	return "/agent/offer/attach-spec-phone";
	}
