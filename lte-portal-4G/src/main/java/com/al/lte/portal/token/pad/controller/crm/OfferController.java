 ...
 * @copyRight 亚信联创EC研发部
 */
@Controller("com.al.lte.portal.token.pad.controller.crm.OfferController")
@RequestMapping("/token/pad/offer/*")
public class OfferController extends BaseController {
	...
	public String queryAttachOffer(@RequestParam("strParam") String param,Model model,HttpServletResponse response){
		...
		try{	
	 	...
	 	return "/padtoken/offer/attach-offer-change";
	}
