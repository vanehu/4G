 ...
 * @copyRight 亚信联创EC研发部
 */
@Controller("com.al.lte.portal.app.controller.crm.ProdController")
...
public class ProdController extends BaseController {
	...
	public String preProdQuery(HttpSession session,Model model){
		...
		return "/app/app/product/product-detail-query";
	}
	 ...
	 * @throws BusinessException
	 */
	@RequestMapping(value = "/prodDetailQuery", method = RequestMethod.POST)
	@AuthorityValid(isCheck = false)
	public String prodDetailQuery(@RequestBody Map<String, Object> params, Model model,@LogOperatorAnn String flowNum, 
		...
		Map<String, Object> paramParse=CommonMethods.getParams(prodIdInfos, "null", "null", getRequest());
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("prodId", ((Map<String, Object>)paramParse.get("prodIdInfoMap")).get("prodInstId"));
		param.put("acctNbr", ((Map<String, Object>)paramParse.get("prodIdInfoMap")).get("accNbr"));
		param.put("areaId", ((Map<String, Object>)paramParse.get("prodIdInfoMap")).get("areaId"));
...
//					model.addAttribute("prodItems", prodItems);//产品属性prodItems(List)组装完成
					...
					if(result.get("offerDtos")!=null){
						...
						return "app/product/product-detail-list";
					}
