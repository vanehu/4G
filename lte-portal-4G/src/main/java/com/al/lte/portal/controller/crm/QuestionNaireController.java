...
public class QuestionNaireController extends BaseController {
	...
	@ResponseBody
	public JsonResponse commit_question(@RequestBody Map<String, Object> param, Model model, HttpServletRequest request,
			HttpServletResponse response, HttpSession httpSession) {
		System.out.println("进入答题结果回写阶段");
		// 1、获取答题的所有结果
		SessionStaff sessionStaff = (SessionStaff) ServletUtils.getSessionAttribute(request,
				SysConstant.SESSION_KEY_LOGIN_STAFF);

		System.out.println("question_params:" + param);
