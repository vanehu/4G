...
public final class PortalServiceCode {
	...
	// "com.linkage.portal.service.ess.core.custorder.QueryOrderList";
	 ...
	 * 最新信息展示
	 */
	// public static final String QUERY_NEW_INFOS =
	// "com.linkage.portal.service.ess.core.system.QueryNewInfos";
	...
	/** todo:定义问卷调查 **/
	public static final String QUESTION_EMP_INFO = "querystaff.do";

	public static final String QUESTION_INFO = "queryTerm.do";
	/** 问卷调查的结果写会接口 **/
	public static final String QUESTION_RESET = "sys-saveQuestionnaireInfo";
	...
	// INTF_OFFER_INST_QUERY="biz-service/intf.prodOfferInstSerivce/queryOfferMemberTestById";
	...
	public static final String INTF_PROTOCOL_QUERY = "biz-service/intf.prodInstService/queryProtocolServiceByConditions"; // 查询协议
																															// add
																															// by
																															// wd
																															// 14-11-3

	public static final String INTF_PROTOCOL_NBR_QUERY = "biz-service/intf.prodOfferService/query"; // 查询协议编码
																									// add
																									// by
																									// wd
																									// 14-11-3

	public static final String INTF_PROTOCOL_OFFER_QUERY = "biz-service/intf.prodInstService/queryOffersByAttrId"; // 查询协议下
																													// 销售品
																													// add
																													// by
																													// wd
	...
	public static final String INTF_PROTOCOL_ADD = "biz-service/intf.detailService/saveProtocol"; // 添加
																									// 协议
																									// add
																									// by
																									// wd
	...
	public static final String INTF_PROTOCOL_OFFER_DETAIL = "biz-service/intf.prodInstService/queryProdInstMemberInfo"; // 协议下
																														// 销售品
																														// 详情
																														// add
																														// by
	...
	/*
	 * public static final String ATTACH_MUST_OFFER = "attachMustOffer"; public
	 * static final String ATTACH_OFFER = "attachOffer"; public static final
	 * String ORDER_SUBMIT = "orderSubmit";
	 */
	// 附属销售品标签查询
	...
	/* 管理渠道 */
	// public static final String QRY_CHANNEL_BY_RELA_STAFF =
	// "chan-service/interact/synStaffBean/qryChannelByRelaStaff";
	...
	// public static final String UPDATE_INVOICE_INVALID =
	// "biz-service/intf.chargeService/updateInvoiceInvalid" ;
	// 主数据查询
