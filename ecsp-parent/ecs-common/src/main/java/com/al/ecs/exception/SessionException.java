...
public class SessionException extends Exception {
	 ...
	 * @param cause  异常堆栈
	 */
	public SessionException(Result result, Throwable cause) {
	 ...
	 * @param msg  错误消息
	 */
	public SessionException(int code, String msg) {
		super(msg);
	 ...
	 */
	public SessionException(boolean isAjax) {
		super(ResultConstant.SESSION_INVALID.getMsg());
		this.result = ResultConstant.SESSION_INVALID;
		this.isAjax=isAjax;
	}
	 ...
	 * @param loginUrl 登录地址
	 */
	public SessionException(boolean isAjax,String loginUrl) {
		super(ResultConstant.SESSION_INVALID.getMsg());
		this.result = new Result(ResultConstant.SESSION_INVALID.getCode(),loginUrl);
		this.isAjax=isAjax;
	}
	 ...
	 */
	public SessionException(Result result, boolean isAjax) {
		super(result.getMsg());
	 ...
	 */
	public SessionException(Result result, String detail) {
	 ...
	 * @param cause  异常堆栈
	 */
	public SessionException(Result result, String detail, Throwable cause) {
	 ...
	 * @param cause 异常堆栈
	 */
	public SessionException(int code, String msg, Throwable cause) {
		super(msg, cause);
		this.result = new Result(code, msg);
	}
	 ...
	 * @param cause	异常堆栈
	 */
	public SessionException(int code, Throwable cause) {
		super(cause);
