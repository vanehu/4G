...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/service/intfurl.js"></script>

<title>平台管理</title>
</head>
<body>
<div class="menu-path">
	<span style="color:#727272">当前位置：服务平台管理</span> &gt; <span style="color:#727272">服务配置</span> &gt; 平台管理
</div>
