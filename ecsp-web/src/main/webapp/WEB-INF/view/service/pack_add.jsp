...
<body>
	<div class="l-form l-group-bg" id="pack_add_page">
		<table width="350px" cellspacing="0" cellpadding="4" border="0">
			<tbody>
			  <tr>
					<td width="100%" colspan="2" align="right">成功保存后关闭对话框：<input style="width: 15px" id="packSaveOkClose" type="checkbox" checked="checked" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colspan="2" width="100%">
						<input type="button" class="l-button l-button-submit" id="btnAddPackSave" value="保        存">
						<input type="button" value="取        消" class="l-button l-button-submit" id="btnAddPackCancle">
					</td>
				</tr>
			</tbody>
		</table>
