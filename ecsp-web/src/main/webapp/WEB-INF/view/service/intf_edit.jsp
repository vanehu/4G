		...
		<table width="350px" cellspacing="0" cellpadding="4" border="0">
			<tbody>
				<tr>
					...
					<td width="70%"><input style="max-width: 300px" disabled="disabled" type="text" maxlength="64" value="" id="intfCode"></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colspan="2" width="100%">
						<input type="button" class="l-button l-button-submit" id="btnEditIntfSave" value="保        存">
						<input type="button" value="取        消" class="l-button l-button-submit" id="btnEditIntfCancle">
					</td>
				</tr>
			</tbody>
		</table>
