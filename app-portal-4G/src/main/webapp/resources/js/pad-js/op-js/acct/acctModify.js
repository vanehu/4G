...
//		} 	
	...
	var _queryAllArea = function(){		
		order.area.chooseAreaTreeManger("report/cartMain","p_bank_areaId_val","p_bank_areaId",3);	
	};
	...
	var _queryBank = function(pageIndex){
		...
		$.callServiceAsHtml(contextPath + "/pad/acct/getBankList",param,{
			"before":function(){
			...
			"done" : function(response){
				//统一弹出框
				var popup = $.popup("#div_bank_dialog",response.data,{
					cache:true,
