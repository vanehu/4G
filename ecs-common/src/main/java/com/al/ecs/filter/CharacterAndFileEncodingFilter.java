...
public class CharacterAndFileEncodingFilter extends OncePerRequestFilter {
     ...
     */
    private static final boolean RESPONSE_SET_CHARACTER_ENCODING_AVAILABLE = ClassUtils.hasMethod(
            javax.servlet.http.HttpServletResponse.class, "setCharacterEncoding", new Class[] { String.class });
