...
public enum ErrorCode {
	...
	POTAL_ORDER_LOG("订单日志记录","110001","01","110001","01"),
    ...
    QUERY_CMP("查询 一证用户用户信息接口","010078","01","170001","17"),
    QUERY_USER_INO("查询 使用人信息接口","010079","01","020444","02"),
    UPDATE_USER_INO("修复一证五号信息接口","01076","01","170002","17"),
    QUERY_CERT_NUM_REL("查询 一证用户证件关系接口","010999","01","170004","17"),
    
    //问卷调查的自定义错误
    QUERY_QUESTION_EMP("查询 问卷调查用户信息接口","010080","01","180001","18"),
    QUERY_QUESTION("查询 问卷调查题目信息接口","010081","01","180002","18"),
    INSERT_QUESTION_RESET("问卷调查结果回写接口","010082","01","180003","18"),
    ...
    PRE_CHECK_ORDER("前置校验接口","010360","01","020151","02"),
    QUERY_LTE_NEW_INSTALL("判断是否集团新装业务","010367","01","020157","02"),
    HIGH_REAL_NAME_AUTHENTICATE("高级实名认证","010368","01","020158","02"),
    REVOKE_AUTHENTICATION("撤销鉴权","010369","01","020159","02"),
    QUERY_AGREEMENTTYPE("橙分期业务标识查询接口","010370","01","020160","02"),
    CUSTINFO_SYNCHRONIZE("客户资料同步接口","010371","01","020161","02"),
    PRE_CHECK_CERT_NUMBER_REL("证号关系预校验接口","010372","01","020162","02"),
    GET_SEQ("获取seq","010373","01","020163","02"),
    CLTORDER_SUBMIT("采集单订单提交","010375","01","020161","02"),
    CLTORDER_COMMIT("采集单订单确认","010376","01","020162","02"),
    CLTORDER_LIST("采集单列表查询","010377","01","020163","02"),
    CLT_ORDER_ITEMS("采集单项查询","010382","01","020182","02"),
    CLTORDER_DETAIL("采集单详情查询","010378","01","020164","02"),
    CLTORDER_INFO("采集单信息","010379","01","010165","01"),
    CLTORDER_INFO_PRINT("实名信息采集单信息打印出错", "010380", "01", "010380", "01"),
    CONFIRMAGREE_MSG_SEND("经办人拍照人证相符审核短信验证","010381","01","050108","05"),
    QRY_OFFER_ORDERED_TIMES("销售品已订购次数查询","010390","01","020165","02"),
    QRY_OFFER_SYN_INFO("销售品同步信息查询 ","010391","01","020166","02"),
  ///***********************************************************ESS异常编码**********************************************************************/
    UPLOAD_FILE("文件上传","010383","01","020364","02"),
    DOWN_FILE("文件上传","010384","01","020365","02"),
    ///***********************************************************ESS异常编码**********************************************************************/
    ...
    SAVE_SIGN_PDF("回执保存","010366","01","020366","02"),
    ...
    QUERY_NFC_APP_INFO("终端销售信息明细统计查询","010147","01","040058","04"),
    PRE_HANDLE_CUST_CERTIFICATE("实名制证件水印处理异常","010149","01","010149","01"),
    UPLOAD_CUST_CERTIFICATE("证件上传","010368","01","020364","02"),
    DOWNLOAD_CUST_CERTIFICATE("证件下载","010369","01","020365","02"),
    CHECK_CUST_CERT("客户信息核验接口","010372","01","020372","02"),
    QRY_PRELININARY_INFO("获取初审信息接口","010374","01","020374","02"),
    SAVE_PHOTOGRAPH_REVIEW_RECORD("实名审核记录接口","010381","01","020381","02"),
    QUERY_PRODINST_STATS("营销标签查询服务接口","010385","01","020385","02"),
    QUERY_MKT_ACTIVITYLIST("营销活动列表查询服务接口","010386","01","020386","02"),
    QUERY_MKT_CUSTLIST("营销推荐清单查询服务接口","010387","01","020387","02"),
    SAVE_MTK_RESULT("营销任务（接触）反馈结果记录服务接口","010388","01","020388","02"),
  ///************************************************************服务层接口异常编码（临时使用）************************************************************/
    ...
    PRINT_ONE_CERT_FIVE_NUMBER("打印一证五号","010167","01","010167","01"),
	...
	PAY_TOKEN("获取支付平台token","011318","01","1300015","13"),
	PAY_REFUND_ORDER("退款","011318","01","1300015","13"),
	PAY_QUERY("支付平台查询订单","011328","01","1300015","13"),
	BILL_CHARGE("翼销售充值","011329","01","011329","01"),
	BILL_BALANCE("翼销售余额查询","011330","01","011330","01"),
	CHECK_DEPOSIT("代理商保证金校验","011334","01","011334","01"),
	BILL_PAYMENT_QUERY("翼销售充值订单查询","011331","01","011331","01"),
	BILL_GET_TRAN_ID("生成csb流水号","011332","01","011332","01"),
	CHECK_MESSAGE("员工身份信息验证","011335","01","050011","05"),
	QUERY_CLOUD_CERT("云平台身份证信息查询","012014","01","022014","02"),
///************************************************************翼销售宽带调用中系接口异常编码************************************************************/
	STAND_ADDRESS("标准地址查询","012001","01","022001","02"),
	RESOURCE_ABILITY("资源预占查询","012002","01","022002","02"),
	TERMINAL_TYPE("终端预判接口","012003","01","022003","02"),
	QUERY_NUMBER("号码资源查询","012004","01","022004","02"),
	NUMBER_REQUEST("号码资源预占/释放","012005","01","022005","02"),
	ACCOUNT_REQUEST("帐号&接入号&密码生成","012006","01","022006","02"),
	MAN_HOUR("预约装机时间查询","012007","01","022007","02"),
	UNITY_ORDER("商机单下发","012008","01","022008","02"),
	SALES_ORDER("销售单下发","012009","01","022009","02"),
	ORDER_DETAIL("订单详情查询","012010","01","022010","02"),
	PIC_VERIFY("人证比对查询","012011","01","022011","02"),
	ONE_CERT_REPORT("一证五号报表查询异常","010389","01","020389","02"),
	//*********************************礼包查询//
	QUERY_GIFT_PACKAGE("礼包查询","012012","01","022012","02"),
	QUERY_GIFT_PACKAGE_MEMBER("礼包成员查询","012013","01","022013","02"),
	QUERY_MKT_CUST_LIST("营销推荐清单查询服务","012015","01","022015","02"),
	...
	PAY_REFUND_ORDER("支付平台退费接口","012015","01","022015","02");
    String name;  
    String code;
    String oppoCode;
    String sys;
