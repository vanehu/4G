...
public class DataAccessException extends RuntimeException {
	 ...
	 * @param cause  异常堆栈
	 */
	public DataAccessException(Result result, Throwable cause) {
	 ...
	 */
	public DataAccessException(Result result, String detail) {
	 ...
	 * @param cause  异常堆栈
	 */
	public DataAccessException(Result result, String detail, Throwable cause) {
