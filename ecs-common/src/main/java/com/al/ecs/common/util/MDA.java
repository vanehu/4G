...
public class MDA {
	 ...
	 * 问卷调查 员工查询
	 */
	public static final String CSB_HTTP_QUESTION_EMP = new String("");
...
//	public static final String CSB_HTTP_QUESTION_RESET = new String("");
	...
	/**
	 * # NONE - 不压缩 # BASE - 第三方和基础JS压缩为一个JS # BUSI -
	 * 第三方和基础JS压缩为一个JS，业务类JS压缩为一个JS
	 */
	...
	/**
	 * 能力开放 销售员与渠道单元的关系开关 如果开关打开选择无归属渠道的发展人不允许选择，如果关闭允许选择
	 */
