/*   
Template Name: UI Template build with Twitter Bootstrap
Version: 1.0
Compiler: Lei Sun
...
var handleResetLocalStorage = function() {
    ...
    $('[data-click=reset-local-storage]').live('click', function(e) {
        ...
        '                <h4 class="modal-title"><i class="fa fa-refresh m-r-5"></i> 重置样式</h4>'+
        '            </div>'+
        '            <div class="modal-body">'+
        '                <div class="alert alert-info m-b-0">确认重置为默认布局和样式？</div>'+
        '            </div>'+
        '            <div class="modal-footer">'+
        '                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal"><i class="fa fa-close"></i> 取消</a>'+
        '                <a href="javascript:;" class="btn btn-sm btn-inverse" data-click="confirm-reset-local-storage"><i class="fa fa-check"></i> 确定</a>'+
        '            </div>'+
        '        </div>'+
        '    </div>'+
        '</div>';
