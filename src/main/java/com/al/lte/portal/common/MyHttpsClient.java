...
import com.al.ec.serviceplatform.client.httpclient.AbortConnectionThread;
...
public class MyHttpsClient {
	...
	private static MyHttpsClient myhttpclient;
	...
	public static MyHttpsClient getInstance() {
		if (null == myhttpclient) {
			myhttpclient = new MyHttpsClient();
		}

		return myhttpclient;
	}

	private MyHttpsClient() {
		iniConfig();
		iniHttpClient();
	}
	...
	private void iniConfig() {
		...
		try {
			// prb =
			// ResourceBundle.getBundle("com/al/ec/serviceplatform/client/config_portalClient");
	...
	public void iniHttpClient() {
		...
		httpclient.getParams().setParameter(
				HttpConnectionParams.CONNECTION_TIMEOUT, this.timeout); // 连接超时
