...
//						_getToken();
	...
	var _getOrderInfo = function(data){
		...
		//省份已拍照经办人信息下省
		if(OrderInfo.order.orderAttrCustId!=null && OrderInfo.order.orderAttrCustId != ""){
			//如果是老客户
			OrderInfo.orderData.orderList.orderListInfo.handleCustId = OrderInfo.order.orderAttrCustId;//经办人查询出的客户ID
		}
