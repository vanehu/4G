 ...
 */
@Controller("com.al.lte.portal.app.controller.cfqController")
@RequestMapping("/app/cfq/*")
@AuthorityValid(isCheck = false)
public class cfqController extends BaseController {
	@Autowired
