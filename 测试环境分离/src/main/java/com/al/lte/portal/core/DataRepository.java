...
//	private Map<String, Object> allCommonParam;//常用参数
	private final Map<String, HashMap<String,String>> allCommonParam; //配置参数,保存不同数据源的配置数据,key-level1:数据源key(省份编码),key-level2:配置数据属性名
	/**
...
//		allCommonParam = new HashMap<String, Object>();
		allCommonParam = new HashMap<String, HashMap<String,String>>();
...
//	public HashMap<String, HashMap<String,String>> getAllCommonParam() {
//		return allCommonParam;
//	}
//	public Object getCommonParam(String key) {
//		return allCommonParam.get(key);
//	}
//	public void setAllCommonParam(HashMap<String, HashMap<String,String>> allCommonParam) {
...
//	}
	...
	public Map<String, HashMap<String,String>> getAllCommonParam() {
		return allCommonParam;
	}
	public void setAllCommonParam(Map<String, HashMap<String,String>> allCommonParam) {
		if(this.allCommonParam != null && allCommonParam != null){
			this.allCommonParam.clear();
			this.allCommonParam.putAll(allCommonParam);
		}
//		this.allCommonParam = allCommonParam;
	}
	public void setCommonParam(String dbKeyWord, HashMap<String,String> commonParam) {
		if(this.allCommonParam != null && commonParam != null){
			this.allCommonParam.put(dbKeyWord, commonParam);
		}
	}
	public void addParam(String dbKeyWord, String paramCode,String paramValue){
		if(dbKeyWord == null || "".equals(dbKeyWord)){
			dbKeyWord = DataSourceManager.DEFAULT_DATASOURCE_KEY;
		}
		if(allCommonParam.get(dbKeyWord) == null){
			allCommonParam.put(dbKeyWord, new HashMap<String,String>());
		}
		HashMap<String,String> sysParams = allCommonParam.get(dbKeyWord);
		sysParams.put(paramCode, paramValue);
		allCommonParam.put(dbKeyWord, sysParams);
	}
	public String getCommonParam(String dbKeyWord, String paramCode){
		if(dbKeyWord == null || "".equals(dbKeyWord)){
			dbKeyWord = DataSourceManager.DEFAULT_DATASOURCE_KEY;
		}
		if(allCommonParam.get(dbKeyWord) == null){
		...
		return allCommonParam.get(dbKeyWord).get(paramCode);
	}
