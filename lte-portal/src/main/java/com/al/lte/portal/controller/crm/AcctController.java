...
public class AcctController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/ifCanAdjustCreditLimit", method = RequestMethod.POST)
    public @ResponseBody JsonResponse ifCanAdjustCreditLimit(@RequestBody Map<String, Object> param, @LogOperatorAnn String flowNum, HttpServletResponse response){
    	
    	SessionStaff sessionStaff = (SessionStaff)ServletUtils.getSessionAttribute(super.getRequest(),SysConstant.SESSION_KEY_LOGIN_STAFF);
    	String iseditOperation= (String)ServletUtils.getSessionAttribute(super.getRequest(), SysConstant.SESSION_KEY_CREDITLIMIT+"_"+sessionStaff.getStaffId());
    	try{
 			if(iseditOperation==null){
 				iseditOperation=staffBmo.checkOperatSpec(SysConstant.ADJUSTCREDITLIMIT_CODE, sessionStaff);
 				ServletUtils.setSessionAttribute(super.getRequest(), SysConstant.SESSION_KEY_CREDITLIMIT+"_"+sessionStaff.getStaffId(), iseditOperation);
 			}			
     ...
     * @throws Exception 
     */
    @RequestMapping(value = "/defaultCreditLimit", method = RequestMethod.POST)
    public @ResponseBody JsonResponse defaultCreditLimit(@RequestBody Map<String, Object> param, @LogOperatorAnn String flowNum, HttpServletResponse response)
    		throws Exception{
    	
    	SessionStaff sessionStaff = (SessionStaff)ServletUtils.getSessionAttribute(super.getRequest(),SysConstant.SESSION_KEY_LOGIN_STAFF);
    	Map<String, Object> dataBusMap = new HashMap<String, Object>();
    	dataBusMap.put("attrId", "30010040");
    	String defaultCreditLimit;
    	try{
    		Map<String, Object> resultMap = acctBmo.defaultCreditLimit(dataBusMap, flowNum, sessionStaff);   			
    		defaultCreditLimit = MapUtils.getString(resultMap, "result", "0");
    	}catch(BusinessException be){
    	...
    	return successed(defaultCreditLimit);
    }
