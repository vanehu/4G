...
public interface PrintBmo {
	...
	Map<String, Object> getEQCodeInfo(Map<String, Object> paramMap, String optFlowNum,
			SessionStaff sessionStaff) throws Exception;
	Map<String, Object> queryOrderListInfoForPrintZT(Map<String, Object> paramMap, String optFlowNum,
			HttpServletRequest request, HttpServletResponse response) throws Exception;
	Map<String, Object> getVoucherData(Map<String, Object> params,
			boolean needAgreement, String optFlowNum, HttpServletRequest request) throws Exception;
	 ...
	 * 实名信息采集单打印-app
	 */
	public Map<String, Object> printCustCltReceiptApp(Map<String, Object> params, String flowNum, SessionStaff sessionStaff,
