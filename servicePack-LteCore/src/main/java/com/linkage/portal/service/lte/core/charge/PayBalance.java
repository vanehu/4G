 ...
 * 余额支取
 */
public class PayBalance extends Service {
	...
	public DataMap exec(DataMap dataMap, String serviceSerial) throws Exception {
		...
		String[] params = { "phoneNumber", "areaCode", "feeAmount", "channelId", "staffId" };
...
//		dataMap.setOutParam(returnMap);
    ...
    private void logPayBalance(DataMap dataMap) throws Exception {
        ...
        logMap.put("PAY_TYPE", LteConstants.CON_PAY_TYPE_PAY_BALANCE);
        logMap.put("USER_CODE", StringUtils.defaultIfEmpty(dataMap.getStaffId(),""));
        logMap.put("PRE_BALANCE", MapUtils.getLongValue(dataMap.getInParam(), "balance",-1));
